...
const useStyles = createUseStyles((theme) => ({
    ...
    separator: {
        backgroundColor: theme.color.lightGreenIshVibe2,
        width: 1,
        minWidth: 1
    },
    statContainer: {
        borderBottom: `1px solid ${theme.color.lightGreenIshVibe2}`,
    ...
    stats: {
        borderTop: `1px solid ${theme.color.lightGreenIshVibe2}`,
        width: '100%'
    },
    statTitle: {
        fontWeight: '600',
        ...
        >
            ...
            >
                <Row wrap horizontal='space-between'>
                    ...
                    {renderLegend(theme.color.lightGreen, 'Today')}
                </Row>
                <div className={classes.graphContainer}>
                    <LineChart
                        data={data}
                        viewBoxWidth={500}
                        pointsStrokeColor={theme.color.lightGreen}
                        areaColor={theme.color.lightGreen}
                        areaVisible={true}
                    />
                </div>
            </Column>
